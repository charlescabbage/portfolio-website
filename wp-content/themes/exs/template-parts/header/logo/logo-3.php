...
?>
<a<?php if ( is_customize_preview() ) : ?> id="logo"<?php endif; ?> class="logo logo-between <?php echo esc_attr( $exs_logo_image_class . ' ' . $exs_logo_background . ' ' . $exs_logo_padding_class ); ?>" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" itemprop="url">
